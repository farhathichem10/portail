...
@Component({
  selector: 'app-gridetablissement',
  templateUrl: './gridetablissement.component.html',
  styleUrls: ['./gridetablissement.component.css']
})
export class GridetablissementComponent  {
  title = "grid";
  api!: GridApi;
  prs:any=[]
  rowData: any[] = [];
